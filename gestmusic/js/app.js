...
function buildTopbar() {
  ...
  <div class="topbar">
    ...
    <div style="display:flex;align-items:center;gap:10px">
      <div style="display:flex;align-items:center;gap:6px;background:rgba(16,185,129,.1);border:1px solid rgba(16,185,129,.25);border-radius:20px;padding:4px 10px">
        <span style="color:var(--green);display:inline-flex">${icon('database',13)}</span>
        <span style="font-size:11px;color:var(--green);font-weight:700;letter-spacing:.5px">IndexedDB</span>
      </div>
